...
// até 5 segundos para que termine o envio. Crie a função sendMarsTemperature, que imprime a temperatura em Marte.
...
const sendMarsTemperature = () => {
  ...
  setTimeout(() => console.log(`Mars temperature is: ${temperaturaAtual}`), messageDelay());
};
